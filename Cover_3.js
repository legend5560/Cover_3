...
(lib.Scene_1_Layer_1 = function(mode,startPosition,loop) {
	...
	this.instance.parent = this;
	this.instance.setTransform(451.5,641.4,1,1,0,0,0,451.5,638.4);
...
(lib.Cover_3 = function(mode,startPosition,loop) {
	...
	this.Layer_1.name = "Layer_1";
	this.Layer_1.parent = this;
	this.Layer_1.setTransform(451.5,641.4,1,1,0,0,0,451.5,641.4);
	this.Layer_1.depth = 0;
	this.Layer_1.isAttachedToCamera = 0
	this.Layer_1.isAttachedToMask = 0
	this.Layer_1.layerDepth = 0
...
lib.properties = {
	...
	manifest: [
		...
		{src:"images/Clouds_1.png", id:"Clouds_1"},
		{src:"images/cover_3_12.png", id:"cover_3_12"},
		{src:"images/myths.png", id:"myths"},
		{src:"images/Cover_3_atlas_.png", id:"Cover_3_atlas_"},
		{src:"images/Cover_3_atlas_2.png", id:"Cover_3_atlas_2"},
		{src:"sounds/AmbienceWind1.mp3", id:"AmbienceWind1"},
		{src:"sounds/MightMagic320bit.mp3", id:"MightMagic320bit"}
	],
	preloads: []
};
